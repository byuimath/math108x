---
title: 'Lesson 6: Visualizing Data'
output:
  html_document:
    fig_caption: false
    theme: default
...
Lesson 6 - Opening story<br> [(2:12 mins, L6 Opening Story Transcript)](https://docs.google.com/document/d/e/2PACX-1vTtpTvKhD4muzJatRn7tH9s95HY8TvJHnXzYaA6ts3kzZ6IPXnclcdPFevSSiZQLvgo4fTISfLM06Dt/pub)
...
<center>
![A tiger crouching in the grass](./Lesson6/images/Tigers.jpg) 
</center>
...
<center>
![Image of the US shaded by county showing life expectancy of males at birth in 1995](./Lesson6/images/UScountiesLifeExpect.png)](data from healthdata.org)
</center>
...
<!-- The data we need to make this chart are publicly available data on the [BYU-Idaho Enrollment Statistics](http://www2.byui.edu/IR/stats/index.htm) website). Using the data we can create the following graphic. -->
...
According to a 2016 official news release of The Church of Jesus Christ of Latter-day Saints, in the fall of 2016 there were `r 152 + 4 + 14 + 11` temples. The article states that there were "152 operating, 4 under renovation, 14 under construction, 11 announced." Create a pie chart that depicts this information. 
...
<center>
![Image of a pie chart depicting the temple information above](./Lesson6/Week 6/Temples.png)
</center>
...
<center>
![A time series plot depicting enrollment figures at BYU-I by semester starting in Fall 2001 and going until Fall 2015](./Lesson6/Week 6/BYUIEnrollments.png)
</center>
...
Download the [BYUIEnrollments.xlsx](./Lesson6/Week 6/BYUIEnrollments.xlsx) data set and open it in Excel.

<center>
![](./Lesson6/Week 6/TimePlot1.png)
</center>
...
<center>
![A scatter plot depicting enrollment figures compared to median debt of student graduates, also included are BYU, BYU-I, and BYU-H's label in the scatter plot](./Lesson6/Week 6/CollegeDebt.png)
</center>
...
#### Excel Instructions - Scatter Plots {.tabset .tabset-fade}

To make the above scatter plot:

##### Step 1

Download the [CollegeDebt.xlsx](./Lesson6/Week 6/CollegeDebt.xlsx) data set and open it in Excel.

<center>
![](./Lesson6/Week 6/CollegeDebt1.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt2a.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt2b.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3a.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3b.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3c.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3d.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3e.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3f.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3g.png)
</center>
...
<center>
![](./Lesson6/Week 6/CollegeDebt3h.png)
</center>
...
<iframe width=780 height=650 frameborder="0" src="./Lesson6/Storyline/Lesson 6Interactive 1 - Storyline output/story_html5.html" style="-webkit-transform:scale(0.8);-moz-transform-scale(0.8);" align="center"></iframe>

L06 - Interactive 1: Practice Reading Graphs<br> [(L06-1 ADA Interactive Transcript)](https://docs.google.com/document/d/e/2PACX-1vSxegR8D7UGy3e9BUZI1zeV62w8H0S5313pyXhEHM_hB9oUVO9sraSRrOt5qrig-b_Ra0WPZ4-tnq38/pub)
...
<br>
<center>
![A scatter plot depicting distance from cyclist to car compared to distance from cyclist to center line](./Lesson6/images/wk6.cyclist copy.png)
...
[^1]: information from an article posted on www.usu.edu
