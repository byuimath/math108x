---
title: 'Lesson 5: Summarizing Data'
output:
  html_document:
    fig_caption: false
    theme: default
...
Lesson 5 - Opening story<br> [(1:22 mins, L5 Opening Story Transcript)](https://docs.google.com/document/d/e/2PACX-1vSAF5JREjySOUTsJe1W097S0ZU-fEQODxoSUCPp8usiNqWRIZY0cIZDx4c3YSKT_SD-uhge-xmU8LUJ/pub)
...
<center>
<div>
<iframe width=780 height=400 frameborder="0" src="./Lesson5/Storyline/Lesson 5 Interactive 1 - Storyline output/story_html5.html" style="-webkit-transform:scale(0.8);-moz-transform-scale(0.8);" align="center"></iframe>

L05 - Interactive 1: Summarizing Data<br> [(L05-1 ADA Interactive Transcript)](https://docs.google.com/document/d/e/2PACX-1vRJwmzTylmRKA_waWov0ZyEzuYd3Vul7LN2ONQytuB6kR4PVmo71GJrMENPAf8GYEmnZGtPmwqxEa3p/pub)
...
<center>
![Image showing the weather of each day of the week. Monday is partly cloudy, has a high of 50 and low of 32. Tuesday is cloudy with a high of 47 with a low of 31. Wednesday is partly cloudy with a high of 50 and a low of 24. Thursday is sunny with a high of 56 and low of 25. Friday is sunny with a high of 59, and a low of 30. Saturday is sunny with a high of 57 with a low of 34. Sunday is partly cloudy with a high of 54 and a low of 34.](./Lesson5/Week 5/TempHiLo.png)
</center>
...
Locating the maximum and minimum values can always be done by hand. However, if we have a lot of values to look at it can be more practical to let Excel find the maximum and minimum for us.
<hr>
...
<center>
![](./Lesson5/Week 5/BlankWorkbook.png)
</center>
...
* highlight the data you are interested in
* finish by typing the closing parentheses `)` and pressing `Enter` or `return`.
* Note that Excel just finds one mode and there might be more than one.

<center>
![](./Lesson5/Week 5/HighLow8.png)
</center>
...
<center>
<div>
<iframe width=780 height=700 frameborder="0" src="./Lesson5/Storyline/Lesson 5 Interactive 2 - Storyline output/story_html5.html" style="-webkit-transform:scale(0.8);-moz-transform-scale(0.8);" align="center"></iframe>

L05 - Interactive 2: Practice<br> [(L05-2 ADA Interactive Transcript)](https://docs.google.com/document/d/e/2PACX-1vQ5oBBLE50rIlEzN6VXMYU-RWDUuxxFNieHygXNEkTUJaEvVJAQK_eHmBo9HKE_5G2ZUais7MN_rclR/pub)
...
## Lesson Checklist  
```{r, child = "Lesson5Checklist.Rmd"}

```


[^1]: <a href="http://www.gallup.com/poll/166211/worldwide-median-household-income-000.aspx " target="_blank">http://www.gallup.com/poll/166211/worldwide-median-household-income-000.aspx</a>
[^2]: Brother Cromar's BYU-I Stats class survey
[^3]: <a href="http://newsfeed.time.com/2012/10/16/size-8-is-the-new-7-why-our-feet-are-getting-bigger/" target="_blank">http://newsfeed.time.com/2012/10/16/size-8-is-the-new-7-why-our-feet-are-getting-bigger/</a>
[^4]: <a href="http://www.ncdc.noaa.gov" target="_blank">http://www.ncdc.noaa.gov</a>
[^5]: <a href="http://www.ncdc.noaa.gov" target="_blank">http://www.ncdc.noaa.gov</a>
